        ...
        <div class="card-body">
            <form v-on:submit.prevent="Registrarse">
                ...
                <div class="form-group row justify-content-left" >
                    ...
                    <small id="helpId" class="form-text text-danger" v-if="errores['email'].lenght != 0">{{errores['email'][0]}}</small>
                </div>
                <br>
                <div class="form-group row justify-content-left" >
            ...
            try {
                ...
                this.$router.go(this.$router.push("/"))
                  ...
                  if (error.response) {
                    ...
                    this.error_msg='Revise los datos del formulario';
                    console.log(error.response.data);

                    var field=[];
                    for (field in error.response.data){
                        console.log("Clave: ", field);
                        console.log("Valor:", error.response.data[field]);
                        this.errores[field]=error.response.data[field];
