                ...
                <table class="table">
                    ...
                    <tbody >
                        <tr v-for="provision in provisiones" :key="provision.codigo">
                            <td>{{provision.procedimiento_provision.entidad.C_DNM_UD_ORGANICA}}</td>
                            <td>{{provision.procedimiento_provision.resolucion_inicio.fecha_publicacion}}</td>
...
export default{
    ...
    created:function(){
        this.consultar();
        this.url_provisiones = this.url + 'puestos_provision/?puesto='+this.puesto_a_consultar;
